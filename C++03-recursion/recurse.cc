...
/*
        ...
        Your function should return the number of times it takes to arrive at 1
  and print each number along the way. for example if we call the function f,
  f(5) -> f(16) -> f(8) -> f(4) -> f(2) -> f(1), the answer return should be 6
